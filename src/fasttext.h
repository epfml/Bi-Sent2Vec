...
class FastText {
  ...
  public:
    ...
    void getVector_ckpt(Vector&, int32_t) const;
    void saveVectors();
    void saveVectors(int32_t);
    void saveOutput();
    void saveModel();
    ...
    void bisent2vec(Model&, real, const std::vector<int32_t>&);
    void transgram(Model&, real, const std::vector<int32_t>&);
